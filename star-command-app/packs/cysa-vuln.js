...
"Priority = severity × exploitability × exposure × asset criticality." ] },
...
{ type: "order", s: "A new vulnerability program run produces raw scan output.", task: "Order the vulnerability management lifecycle steps:",
 steps: ["Discover and inventory assets in scope", "Scan (credentialed where possible)", "Validate findings and remove false positives", "Prioritize by risk (severity × exploitability × exposure × asset value)", "Remediate or apply compensating controls", "Rescan to validate remediation and report"],
